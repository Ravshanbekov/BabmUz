        ...
        <div class="card col-lg-12">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $slider->title_uz }}" class="form-control form-control-sm" name="title_uz" required>
                </div>
                <div class="form-group">
                    <label>Tafsifi</label>
                    <input type="text" value="{{ $slider->description_uz }}" class="form-control form-control-sm" name="description_uz" required>
                </div>
                <h4 style="margin-top: 20px; margin_left:300px">Ru</h4>
                <br>
                <div class="form-group">
                    <label>Заголовок</label>
                    <input type="text" value="{{ $slider->title_ru }}" class="form-control form-control-sm" name="title_ru" required>
                </div>
                <div class="form-group">
                    <label>Описание</label>
                    <input type="text" value="{{ $slider->description_ru }}" class="form-control form-control-sm" name="description_ru" required>
                </div>
                <h4 style="margin-top: 30px;">En</h4>
                <br>
                <div class="form-group">
                    <label>Title</label>
                    <input type="text" value="{{ $slider->title_en }}" class="form-control form-control-sm" name="title_en" required>
                </div>
                <div class="form-group">
                    <label>Description</label>
                    <input type="text" value="{{ $slider->description_en }}" class="form-control form-control-sm" name="description_en" required>
                </div>
                <div class="form-group">
                    <label>Link</label>
